...
Requiere Docker con Compose v2.30+ y, para GPU, NVIDIA Container Toolkit. Los secretos y el modelo adecuado a tu GPU se generan solos en el primer arranque. Detalles en `docs/DOCKER.md`; para abrir el panel de OpenClaw desde el móvil o el portátil por Tailscale, `docs/ACCESO-REMOTO.md`, y para tener la memoria de Jarvis en Obsidian, `docs/OBSIDIAN.md`.
