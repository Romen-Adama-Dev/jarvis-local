...
| ~~Documentación~~ ✅ 21-09 | `docs/ACCEPTANCE.md` al día: 24 de 27 criterios verificados; el 2 (reinicio) falta repetirlo con el arreglo de Tailscale, el 14 (abstención) marca bien la respuesta pero no el campo `insufficient_evidence`, y el 16 (`/deep`) no termina en esta VM | Media |
