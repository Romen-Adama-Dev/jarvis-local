---
name: agile-toolkit
description: Coaching ágil práctico (Scrum, Kanban, SAFe, Management 3.0) para retros, planificación, historias, dailies, métricas y salud del equipo
---

<!-- Skill de terceros: ClawHub olivermonneke/agile-toolkit v1.0.0 (MIT-0), revisada y copiada sin cambios salvo este frontmatter y la nota de uso. Ver README.md de esta carpeta. -->

Responde siempre en el idioma del usuario (normalmente español). Esta skill es solo conocimiento: si de aquí salen historias o tareas para OpenProject, enseña antes el resumen y créalas con `jarvis-pm` solo cuando el usuario diga «sí».
